 ...
 * accelerometer.h
 *
 * Support for interfacing with the ADXL345
 * accelerometer on the Orbit BoosterPack.
 *
 * Authors: T.J. Mitchell and S.G. Jackson
 * Date modified: 31/03/2022
 * Provenance: 'acc.h' module by C.P. Moore on 24 Feb 2020
 *
 *******************************************************/
...
// Function to return accelerometer readings in 3D
vector3_t getAccData (void);
